...
* **The `shinypup` AI Proof-of-Concept:** In September 2024, we developed an exploratory AI bot called [`shinypup`](https://github.com/smallielabs/shinypup). Its specific goal was to act as an "AI live blogger" that observed and reported on a series of statistical simulations using external browser automation (Puppeteer navigating a Shiny app) ([Live Demo Recording](https://www.youtube.com/watch?v=_KuTATJK7MA)).
...
* **Context Injection Pipeline:** Mechanisms for app builders to incorporate foundational research papers into the system prompt, and for end-users to upload supplementary PDFs.
